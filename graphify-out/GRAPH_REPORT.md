...
## Corpus Check
- 88 files · ~51,698 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 613 nodes · 1200 edges · 43 communities (35 shown, 4 thin omitted)
...
## Knowledge Gaps
- **227 isolated node(s):** `$schema`, `oxc`, `react/rules-of-hooks`, `warn`, `name` (+222 more)
